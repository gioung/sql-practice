...
select gender,count(*) as '인원' from employees group by gender;

-- 문제4.현재 근무하고 있는 직원 수는 몇 명입니까? (salaries 테이블을 사용합니다.) 
select count(*) as '직원수' from salaries where to_date='9999-01-01';

-- 문제5.부서는 총 몇 개가 있나요?
select count(*) as '부서 수' from departments;
...
select count(*) as '엔지니어 수' from titles where title='Engineer' 
and to_date='9999-01-01';

-- 문제11.사번이 13250(Zeydy)인 직원이 직책 변경 상황을 시간순으로 출력해보세요.
